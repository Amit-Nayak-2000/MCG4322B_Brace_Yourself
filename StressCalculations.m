...
%STRESSCALCULATIONS
%This function calculates the critical stresses on the members of the brace
%Kinematics and Kinetics are run first.
%Frontal Plane stresses will be derived from a static case (worst varus
%valgus moment).
%Need to check what I added here is in the objects.
%Need to modify the forces such that they are easy to use. 
