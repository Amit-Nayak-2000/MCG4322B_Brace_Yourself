classdef InferiorLink < handle
    ...
    methods
        ...
        function obj = calculateCOM(obj, calflength)
            ...
            comx = -(obj.B2/2 + Xcom)*cosd(obj.theta) - (0.433*calflength -(obj.H4-Ycom))*sind(obj.theta);
            comy = -(obj.B2/2 + Xcom)*sind(obj.theta) + (0.433*calflength -(obj.H4-Ycom))*cosd(obj.theta);
